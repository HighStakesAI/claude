...
```bash
"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run content_humanize.py draft.md -o cleaned.md
cat draft.md | "$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run content_humanize.py --json
```
