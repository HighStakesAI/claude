...
This is enforced, not advisory: `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run validate_backlink_report.py` fails
...
- **Command:** `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run moz_api.py`
...
- **Command:** `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run bing_webmaster.py`
...
- **Command:** `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run verify_backlinks.py`
