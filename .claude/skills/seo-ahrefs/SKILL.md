...
1. Estimate cost with `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run dataforseo_costs.py` (the cost-tracker module is generic and supports Ahrefs unit accounting).
