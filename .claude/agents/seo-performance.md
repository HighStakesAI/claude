...
2. Use `"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run render_page.py URL --mode auto --json
...
```bash
"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run pagespeed_check.py URL --json
"$(git rev-parse --show-toplevel)/.claude/skills/seo/scripts/claude-seo" run crux_history.py URL --json
```
